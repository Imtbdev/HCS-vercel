 ...
 * @type {string}
 */
export const DEFAULT_LOGIN_REDIRECT: string = ROUTE_LINKS.main;
export const DEFAULT_LOGOUT_REDIRECT: string = ROUTE_LINKS.auth.login;
...
export const ADMIN_ROUTE_START: string = ROUTE_LINKS.admin.main;
